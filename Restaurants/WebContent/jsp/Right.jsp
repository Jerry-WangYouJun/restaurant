...
<title>Insert title here</title>
	...
	function selectorder(){
	     window.location.href="${pageContext.request.contextPath}/selectOrderFen.action?index="+1;
	}
		...
		<div class="dropdown" style="display: inline;position: relative;left: 85%;">
				...
				<c:choose>
		  		 	  ...
		  		 	  <c:when test="${userBean.role eq '2' }">
				       		 ...
				       		 <li><a href="${pageContext.request.contextPath}/selectMainOrder.action">历史订单</a></li>
			            	 <li><a  href="${pageContext.request.contextPath}/selectDishFen.action" style="cursor:hand">菜品编辑</a></li>
		  		 	  </c:when>
			...
			<div class="panel panel-default">
		  	<div class="panel-heading">
			        ...
			        <button type="button" class="btn btn-success">菜品编辑</button>		    
					...
					<div class="col-md-2">
							<span class="thumbnail">
				      			...
				      			<div class="row">
				      				...
				      				<div class="col-md-6 col-sm-6">
				      				 	<a href="${pageContext.request.contextPath}/dishbuy.action?name1=${list.dish_name}&price1=${list.dish_price}&id=${list.dish_id}" target="_parent"><button type="button" class="btn btn-primary btn_left">Buy</button></a>
				      				</div>     				
				      			</div>
				    		</span>
					</div>
